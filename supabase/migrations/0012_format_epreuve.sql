-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║ mister-miss-koh — Une conversion manquante sur le format d'épreuve         ║
-- ║                                                                          ║
-- ║ `update challenges set format = case … end` rendait du `text` là où la     ║
-- ║ colonne attend un `challenge_format`. PostgreSQL refuse — et il a raison :  ║
-- ║ une énumération qui accepterait n'importe quelle chaîne ne servirait à     ║
-- ║ rien. La transaction entière a été défaite, donc rien n'a été publié à     ║
-- ║ moitié : c'est le tout-ou-rien qui a joué son rôle.                       ║
-- ║                                                                          ║
-- ║ Le corps de la fonction est celui de 0010, à cette conversion près.        ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
