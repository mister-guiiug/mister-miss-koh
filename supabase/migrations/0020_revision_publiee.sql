-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║ mister-miss-koh — La révision publiée, écrite sur le document source      ║
-- ║                                                                          ║
-- ║ L'écran « Source de vérité » affiche la page, sa révision et la date où  ║
-- ║ elle a été lue. Il les lit dans `source_documents` — que personne        ║
-- ║ n'écrivait : l'import garde la révision sur l'exécution, la publication  ║
-- ║ ne la reportait pas. La saison en ligne ne pouvait donc pas dire de      ║
-- ║ quelle révision elle vient.                                              ║
-- ║                                                                          ║
-- ║ `publish_run` estampille désormais le document au moment où le lot      ║
-- ║ s'applique : la révision et la date de lecture de l'exécution publiée.   ║
